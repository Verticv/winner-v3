        ...
        <div className="relative flex h-32px items-center justify-center">
            ...
            >
                ...
                <div className="space-x-px flex items-center -ml-2px">
                    ...
                    className={`${selectedPage === 2?'shadow-link':''} flex items-center justify-center w-32px h-32px rounded-4px hover:filter hover:brightness-125`}
                    ...
                    className={`${selectedPage === 3?'shadow-link':''} flex items-center justify-center w-32px h-32px rounded-4px hover:filter hover:brightness-125`}
                    ...
                    <button 
                        ...
                        className={`${selectedPage === 4?'shadow-link':''} flex items-center justify-center w-32px h-32px rounded-4px hover:filter hover:brightness-125`}
                    ...
                    className={`${selectedPage === 5?'shadow-link':''} flex items-center justify-center w-32px h-32px rounded-4px hover:filter hover:brightness-125`}
