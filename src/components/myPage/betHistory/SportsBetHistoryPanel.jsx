...
const SportsBetHistoryPanel = ({
    ...
    >
      ...
      <div className="flex space-x-2px -mr-2px mt-px">
        ...
        >
          ...
          >
            <span
              ...
              className={`truncate text-left tracking-tight text-14px overflow-ellipsis pb-px`}
            >
              {team1}
            </span>
            <div className="flex items-center space-x-5px">
              {hasUp && <img className="object-none" src={UpIcon} alt="" />}
              <span className="font-roboto tracking-tight text-14px pb-px">
                {stat1}
              </span>
            </div>
          </div>
        ...
        >
          <div
            style={{ width: "81px" }}
            className={`${bet === "middle" ? "text-r666666" : "text-r666666"}
        ...
        >
          <div
            className={`${bet === "right" ? "text-white" : "text-r666666"} 
          ...
          >
            ...
            <span
              ...
              className={`truncate  tracking-tight text-14px text-right overflow-ellipsis pb-px`}
            >
              {team2}
            </span>
          </div>
      ...
      <div className="flex ml-6px tracking-tight text-14px text-center">
        <div
          style={{ width: isAttached ? "90px" : "99px" }}
          className="font-roboto text-r666666 pl-6px"
        >
          {score}
        </div>
        <div
  ...
  const Cards1 = ({ hasUp = true, hasDown = true }) => (
    ...
    >
      ...
      <div
        className="flex flex-col w-full bg-gray-fefefe border-gray-dddddd"
      ...
      <div className="w-full bg-white rounded-10px pb-10px overflow-hidden">
        ...
        >
          ...
          <div
            style={{
              width:
                isAttached === true ? (isFullPage ? "90px" : "85px") : "99px",
              paddingLeft: isPopup
                ? "9px"
                : !isAttached
                ? "7px"
        ...
        >
          <table>
            <div
              ...
              } flex h-36px rounded-4px bg-dark-252525 text-14px tracking-tightest text-r666666 overflow-hidden`}
            >
              {isAttached === false && (
                <div
            ...
            <div
              className={`flex w-auto h-36px  text-14px tracking-tight text-r666666 ${
                isPopup && "pt-2px"
              }`}
            >
              ...
              <div
                style={{
                  WebkitTextStroke: winAmount.includes("+") && "0.2px",
                  width:
                    noButtons === true
                      ? "236px"
                      : isAttached === true
              ...
              >
                ...
                <p style={{ WebkitTextStroke: "0px" }}>원</p>
              </div>
            </div>
          </table>
          ...
          <div className="flex space-x-6px pr-3px">
            {isAttached === false && (
              ...
              >
                ...
                >
                  <span className=" tracking-tightest text-14px text-white text-shadow-5">
                    내역올리기
                  </span>
                </div>
              </button>
