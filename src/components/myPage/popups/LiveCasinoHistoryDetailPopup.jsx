                ...
                >
                    ...
                    <div className="flex flex-col">
                        <div 
                            ...
                            className="flex items-center justify-center text-14px   overflow-hidden text-white border-b-2 font-bold"
                        >
                        ...
                        <div className="flex">
                            <div 
                                ...
                                className="flex flex-col w-full border-r text-14px   text-r444444"
                            >
                                <div 
                                ...
                                <div 
                                    ...
                                    className="h-40px flex items-center justify-center text-14px   text-white font-bold"
                                >
                                    뱅커 핸드
                                </div>
                                ...
                                <div style={{height:"40px"}} className="flex">
                                    <div 
                                        ...
                                        className="flex items-center justify-center text-14px  text-white border-r border-white font-bold"
                                    >
                                        베팅
                                    </div>
                                    <div 
                                ...
                                <div style={{height:"42px",borderColor:'#dddddd'}} className="flex font-robotoRegular text-r444444">
                                    <div 
                                        style={{ width:"71px"}}
                                        className=" flex items-center justify-center text-14px  border-r"
                                    >
                                        player
                                    </div>
                                    <div 
                            ...
                            <div 
                                style={{backgroundColor:"#fff",borderColor:'#dddddd'}} 
                                className="flex flex-col w-full  text-14px font-robotoRegular  text-r444444"
                            >
                                <div 
                                    style={{height:"41px",borderColor:'#dddddd'}} 
                                ...
                                <div style={{height:"40px"}}  className="flex">
                                    <div 
                                        style={{backgroundColor:"#905cc4"}}
                                        className=" flex items-center justify-center text-14px   text-white w-full border-r border-white font-bold"
                                    >
                                        거래아이디
                                    </div>
                                    <div 
                                        style={{backgroundColor:"#905cc4"}}
                                        className=" flex items-center justify-center text-14px   text-white w-full font-bold"
                                    >
                                        베팅시간
                                    </div>
                                </div>
                                ...
                                <div style={{height:"41px",borderColor:'#dddddd'}} className="flex font-robotoRegular text-r444444">
                                    <div 
                                        style={{}}
                                        className=" flex items-center justify-center text-14px  border-r w-full "
                                    >
                                        85040508001
                                    </div>
                                    <div 
                                        style={{}}
                                        className="flex flex-col -space-y-6px items-center justify-center text-14px  w-full "
                                    >
                                        <p>2021-08-09</p>
                                        <p>18:26:27</p>
                                    </div>
