    ...
    return (
        <div className="flex w-full justify-between">
            <div className="flex w-full">
                ...
                <label className="font-bold text-22px ml-4px -mt-4px text-shadow-5 tracking-tightest" style={{color:'#eeeeee'}} >{title}</label>
                {couponCount && (
                    <>
                        <div className="ml-20px h-21px flex items-center space-x-20px mt-2px">
                            ...
                            <div className="font-medium tracking-tightest text-gray-c8c8c8 space-x-2px">
                ...
                {pointsFor && (
                    <div className="ml-20px h-21px flex items-center space-x-20px mt-2px">
                        <div style={{backgroundColor:"#4c4c4c"}} className="h-12px w-px bg-gray-r8c8c8c mb-px" />
                        <div className="font-medium tracking-tightest text-gray-c8c8c8 space-x-2px flex">
                ...
                {inboxCount && (
                    <div className="ml-18px h-21px flex items-center space-x-18px mt-2px">
                        ...
                        <div className="font-medium tracking-tightest text-gray-c8c8c8">
