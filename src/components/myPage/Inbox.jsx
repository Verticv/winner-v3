...
const Inbox = () => {
  ...
  const [checkedState, setCheckedState] = useState(new Array(inboxArray.length).fill(false));
  ...
  const InboxSearch = (
    ...
    // >
    <div
      className={`h-62px w-full mt-10px flex items-center justify-center space-x-10px rounded-6px`}
