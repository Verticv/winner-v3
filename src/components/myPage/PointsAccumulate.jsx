        ...
        <div className="w-full flex flex-col items-center">
            ...
            <div className="flex mt-20px h-100px space-x-6px">
                <div style={{width:'202px'}} className="flex items-center justify-center rounded-4px h-100px border-2 border-golden-a47b51 bg-gray-272624">
                    <div style={{borderRadius:"8px", width:'200px',height:'96px'}} className="pt-21px flex items-center flex-col">
                ...
                <div style={{width:'202px'}} className="pt-21px items-center rounded-4px flex-col flex h-100px bg-gray-272624 border-2 border-gray-404040">
