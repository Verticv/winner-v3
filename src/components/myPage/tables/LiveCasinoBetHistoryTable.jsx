    ...
    function Cells({ items }) {
        ...
        const detailButton = (
            <button 
                ...
                className="rounded-4px text-13px tracking-tight pt-2px flex-shrink-0 hover:filter hover:brightness-125"
            >
                상세보기
            </button>
        ) 
      ...
      <div
       style={{ background: "linear-gradient(to top, #ededeb, #cb78e6)" }}
        ...
        <div className="rounded-10px overflow-hidden">
              <div className="text-14px tracking-tight text-gray-ccc2b6 h-55px flex items-center pt-px border-b pr-14px"
               style={{ background: "linear-gradient(to right, #9d3bbb, #5423a0)" , color:"#eeeeee",borderColor:"#dddddd"}}>
                ...
                <div style={{width: "126px"}} className="text-center pr-22px">베팅금액</div>
                <div style={{width: "128px"}} className="text-center">적중/손실금액</div>
