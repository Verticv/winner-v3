...
const CouponGift = () => {
    ...
    const GiftButton = (
        <div style={{width:'128px',background:'linear-gradient(to right, #15cfee, #3197e5)',boxShadow: '0px 2px 2px 0px rgba(0, 0, 0, 0.3)'}} className="flex items-center justify-center h-36px rounded-6px p-px hover:filter hover:brightness-125">
    ...
    return (
        <div className="flex flex-col w-full items-center">
            <div className="w-full flex justify-between">
                ...
                <div className=" text-16px w-full text-right text-eeeeee space-x-4px h-16px mt-px" style={{letterSpacing:'-0.1em'}}>
                    <span className="font-bold mt-px" style={{color:'#ffd98b'}}>쿠폰선물하기</span>
