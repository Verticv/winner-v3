...
import Image1 from "../../images/liveSport/ls3_g01.png";
import Image2 from "../../images/liveSport/ls3_g02.png";
import Image3 from "../../images/liveSport/ls3_g03.png";
import Image4 from "../../images/liveSport/ls3_g04.png";
import Image5 from "../../images/liveSport/ls3_g05.png";
import Image6 from "../../images/liveSport/ls3_g06.png";

const LiveSportMulti = () => {
  const Item = ({
    number = "1.",
    title = "싱글뷰 및 멀티뷰",
            ...
            <div style={{ backgroundColor: "#ffffff", height: "392px" }} className="w-full h-full rounded-xl p-20px">
              <div className="space-y-23px">
                <Item
                  ...
                  text="① 멀티뷰를 선택합니다."
                  text2="② 종목을 선택합니다."
                  text3="③ 원하는 경기를 더블클릭 합니다."
                  text3_1="- 또는 비어 있는 ④ 화면에 드래그 추가 가능"
                  text3_2="- 최대 9개 경기 추가 가능"
                />
              </div>
            </div>
          </div>
