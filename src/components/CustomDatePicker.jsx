...
const CustomDatePicker = ({ classes }) => {
  ...
  const yearButton = (
    <div
      style={{ backgroundColor: "#3b3b3b", borderColor: "transparent" }}
      className="flex items-center justify-between  placeholder-gray-r8c8c8c outline-none border px-px font-spoqa text-13px font-bold tracking-tight   border-gray-2e2e2e text-gray-ccc2b6 bg-gray-2e2e2e"
    >
        ...
        renderCustomHeader={({
          ...
          >
            ...
            >
              <div
                style={{ height: "249px" }}
                className="w-70px mt-4px flex flex-col items-center justify-center overflow-hidden rounded-2px border font-spoqaMedium text-14px tracking-tight border-gray-404040 text-gray-ccc2b6 bg-dark-1a1a1a"
              >
