...
import img1Logo from "../../images/navbarHover/4_1_logo.png";
...
const HotelCasinoHover = ({ selection }) => {
  ...
  const hoverMenuPosition = useNavButtonPosition("menu-wrapper", "navbar-3-button");
    ...
    return items.map((item) => (
      <>
        ...
        >
          ...
          <div style={{ marginLeft: "-10px" }} className={`absolute bottom-0 object-none h-auto z-40`}>
            <img src={item.background} alt="game_image" />
          </div>
