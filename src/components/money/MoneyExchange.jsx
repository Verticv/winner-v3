...
const MoneyExchange = () => {
    ...
    const Title = ({text}) => (
        <div style={{ width: "201px", background: '#9b6bd4' }}
            ...
            <div className=" text-white tracking-Stightest font-bold text-16px">{text}</div>
        </div>
    )
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div style={{height:'157px',borderColor:'#cccccc'}} className="mt-11px w-full rounded-8px border bg-white px-19px pt-18px font-bold">
                ...
                <div className="mt-12px flex flex-col space-y-16px text-r666666 tracking-tight  text-16px" style={{letterSpacing: '-0.1em'}}>
                    <span className="h-14px space-y-4px"><span className="font-bold mr-3px mt-px">✓</span>  환전 신청 시 현재 보유머니에서 차감되며, 회원님의 계좌번호로 입금됩니다.</span>
                    <span className="h-14px space-y-4px"><span className="font-bold mr-3px mt-px">✓</span>  입금이 지연될 수 있으니 은행 점검 시간을 확인하신 후 점검 시간을 피해 신청해 주시기 바랍니다.</span>
                    <span className="h-14px space-y-4px"><span className="font-bold mr-3px mt-px">✓</span>  자세한 문의사항은 고객센터를 이용해 주시기 바랍니다.</span>
                </div>
            </div>

            <div style={{height: "474px", background: "linear-gradient(to top, #ededeb 0%,      #cb78e6 100%)",
                    boxShadow: "0px 0px 8px 0px rgba(0, 0, 0, 0.5)", }} className="rounded-6px  overflow-hidden p-px mt-20px w-full">
              <div className='h-full w-full rounded-6px overflow-hidden bg-white p-9px'>
                <div style={{height: "128px", borderColor: '#5e399a',
                    ...
                    <div className="text-16px tracking-tight text-eeeeee h-16px flex items-center ml-55px mt-3px" >
                        고객님의 계좌번호로 입금됩니다.
                    </div>
                </div>
                        ...
                        <div className="h-44px w-full overflow-hidden"
                            ...
                            <form autoComplete="off">
                                <input 
                                   ...
                                   className="w-full text-16px outline-none pl-11px placeholder-r666666 h-42px border-b mt-2px"
                ...
                <div style={{marginLeft: "277px", paddingRight:'115px'}} className={`mt-21px flex space-x-5px w-full justify-start`}>
                    <button 
                       style={{
                    ...
                    >
                        ...
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px">1만원</span>
                        </div>
                    </button>
                    ...
                    >
                        <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px">3만원</span>
                        </div>
                    </button>
                    ...
                    >
                        <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px">5만원</span>
                        </div>
                    </button>
                  ...
                  <button 
                    ...
                    >
                        <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px ">10만원</span>
                        </div>
                    </button>
                ...
                <button 
                 style={{
                    ...
                    >
                        <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px">30만원</span>
                        </div>
                    </button>
                ...
                <button 
                  style={{
                    ...
                    >
                        <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px">50만원</span>
                        </div>
                    </button>
                ...
                <button 
                  style={{
                    ...
                    >
                        <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                        style={{background:'linear-gradient(to top, #e5e5e5, #ffffff)'}}>
                                <span className="tracking-tight text-14px text-r666666 -mt-px">100만원</span>
                        </div>
                    </button>
                ...
                <div style={{width: "906px"}} className="ml-57px mt-42px flex flex-col">
                    <div className="flex space-x-8px">
                        ...
                        <div className="h-44px w-full overflow-hidden"
                            ...
                            <input 
                                 style={{ background: "#fff", borderColor: "#e2e2e2", color: "#444444" }}
                                   className="w-full text-16px outline-none pl-11px placeholder-aaaaaa h-42px border-b mt-2px"
