...
const MoneyExchange = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div style={{height:'157px',borderColor:'#cccccc'}} className="mt-9px w-full rounded-8px border bg-white px-19px pt-20px">
                <div className="flex items-center h-26px space-x-9px">
                    <img src={AlertIcon} alt="" />
                    <span className="text-rf04281 font-spoqaMedium text-20px tracking-tight -mt-2px" style={{WebkitTextStroke:"0.2px"}}>확인 / 필독사항</span>
                </div>
                
                <div className="mt-12px flex flex-col space-y-16px text-r666666 tracking-tight  text-16px" style={{letterSpacing: '-0.09em'}}>
