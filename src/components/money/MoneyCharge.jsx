    ...
    return (
        <div className="flex flex-col items-center">
                    ...
                    className="w-full rounded-4px border">
                        ...
                        <div style={{marginLeft: "76px", marginTop: "18px"}} className="space-y-11px">
                            <div className="h-19px flex items-center text-16px tracking-minus05 text-eeeeee">
                                <img src={Step1} alt="" />
                                <div className="mt-px ml-8px flex">위 <p className="font-bold ml-3px" style={{color:'#fee300'}}>계좌번호 신청</p>버튼을 누르시면 계좌번호가 쪽지로 발송됩니다.</div>
                            </div>
                            <div className="h-19px flex items-center text-16px tracking-minus05 text-eeeeee">
                                <img src={Step2} alt="" />
                ...
                <div className="flex items-center justify-center h-40px w-73px  rounded-6px  cursor-pointer hover:brightness-125 filter"
                    ...
                    <div style={{width: "906px", marginTop:"23px"}} className="ml-57px flex flex-col">
                        ...
                        <div style={{ width: "906px", borderColor: '#cccccc', background: '#f7f7f7' }}
                            ...
                            <div className="mt-12px flex flex-col space-y-17px text-r666666 tracking-tight text-16px"
                            style={{letterSpacing: '-0.1em'}}>
            ...
            <div className="-mt-18px w-full flex  items-center justify-center  mb-30px">
                <div style={{width: '332px' ,background:'linear-gradient(to right, #df52ff, #6b22ff)', boxShadow: "0px 2px 2px 0px rgba(0, 0, 0, 0.3)"}} className='rounded-full flex justify-center items-center h-42px  text-20px tracking-tight text-white'><span className='mt-px'>은행점검시간</span>  </div>
            </div>                        
            <BankTable />
