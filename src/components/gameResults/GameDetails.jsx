    ...
    <div className="flex space-x-2px">
      ...
      >
        <div
          ...
          className={` 
                    flex items-center justify-between h-36px rounded-3px cursor-pointer pl-11px pr-9px`}
        >
          <span
            style={{ width: "223px" }}
      ...
      >
        <div
          ...
          className={`
          flex items-center justify-center h-36px rounded-3px cursor-pointer `}
        >
      ...
      >
        <div
          ...
          className={`
           flex items-center justify-between h-36px rounded-3px cursor-pointer pr-9px pl-11px`}
        >
