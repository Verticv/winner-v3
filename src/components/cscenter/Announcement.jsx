...
const Announcement = () => {
  const tabsArray = [
    { text: "전체", icon: Icon1, iconHighlight: IconHighlight1, id: 0, path: "/cscenter/announcement/all" },
    {
      ...
      id: 1,
      path: "/cscenter/announcement/all/live-casino",
    },
    { text: "스포츠", icon: Icon3, iconHighlight: IconHighlight3, id: 2, path: "/cscenter/announcement/all/slot" },
    {
      ...
      id: 14,
      path: "/cscenter/announcement/all/live-sport",
    },
    { text: "슬롯게임", icon: Icon4, iconHighlight: IconHighlight4, id: 3, path: "/cscenter/announcement/all/sports" },
    {
      ...
      id: 4,
      path: "/cscenter/announcement/all/hotel-casino",
    },
    {
      text: "홀덤게임",
      icon: Icon15,
      ...
      id: 15,
      path: "/cscenter/announcement/all/holdem",
    },
    {
      text: "e-스포츠",
      icon: Icon6,
      ...
      id: 5,
      path: "/cscenter/announcement/all/e-sports",
    },
    {
      text: "미니게임",
      icon: Icon7,
      ...
      id: 6,
      path: "/cscenter/announcement/all/minigame",
    },
    {
      text: "키론가상게임",
      icon: Icon8,
      ...
      id: 7,
      path: "/cscenter/announcement/all/ar-game",
    },
    {
      text: "피싱게임",
      icon: Icon9,
      ...
      id: 8,
      path: "/cscenter/announcement/all/phishing-game",
    },
    { text: "티비벳", icon: Icon10, iconHighlight: IconHighlight10, id: 9, path: "/cscenter/announcement/all/bet" },
    {
      ...
      id: 10,
      path: "/cscenter/announcement/all/transaction",
    },
    {
      text: "베팅관련",
      icon: Icon16,
      ...
      id: 11,
      path: "/cscenter/announcement/all/about-betting",
    },
  ...
  const dropdownButton = (
    <div
      style={{ width: "120px" }}
      className="flex h-42px bg-dark-1a1a1a rounded-6px border border-p682aa7 text-r666666 bg-white mb-px group"
    >
  ...
  const InboxSearch = (
    ...
    >
      ...
      <div style={{ width: "381px" }} className="flex h-42px  rounded-6px border border-p682aa7 relative">
        <input
          style={{ color: "#444" }}
          className="pl-11px rounded-md pb-2px placeholder-r666666 w-full font-spoqaMedium text-14px outline-none h-full justify-between items-center tracking-tight"
