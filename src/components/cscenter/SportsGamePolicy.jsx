...
const LiveSportSubArray = [
  {
    ...
    text: "라이브스포츠 배팅은 실시간 경기 진행 상황에 따라 배팅수락,지연 또는 거절 될 수 있습니다.",
    text2:
      "위험지대 배팅 PK, 코너킥, 프리킥, 파울, 부킹, 선수교체, VAR, 투수교체, 안타, 투수교체 등 경기 결과에 영향을 줄 수있는 상황이 진행중인 상태입니다. 대기중인 배팅은 경기에 영향을 끼칠 수 있다고 판단될 시, 거절/취소될 수 있으며 위엄지대 이후 경기 결과가 변동되지 않을 경우 배팅은 지연 수락될 수 있습니다.",
    text3:
      "배팅 종류별(승무패, 핸디캡 등) 정규시간, 연장포함, 특정 이닝/쿼터/세트 등 구분되며 정해진 경기시간 내 결과로 처리됩니다.",
  },
  {
    id: 0,
    title: "축구",
    color: "rgb(240, 66, 129)",
    text: "모든 배팅은 90분 경기 완료전 경기가 종료되었거나 중단될  경우 경기는 모두 무효처리 됩니다.",
    text2:
      "85분 이상 경기 진행 이후 심판이 공식결과를 발표하며 시합을 종료할 경우는 예외입니다.(공식 결과에 따릅니다.)",
    text3: "라이브 핸디캡 배팅의 경우 기존 점수는 포함 되지 않으며, 배팅 시점 핸디캡으로 반영 됩니다.",
    text4: "라이브 언더오버 배팅의 경우 기존 점수를 포함하며, 최종점수에 기준점이 반영 됩니다.",
    text5: "위험지대 배팅으로 대기중 베팅은 취소 될 수 있습니다.(파울, 부킹, 코너킥, 프리킥, PK, 선수교체 등)",
  },
  {
    id: 0,
    title: "야구",
    color: "rgb(240, 66, 129)",
    text: "승패 배팅시 시작 전에 진행된 베팅은 5회말(홈팀이 승리시 5회초 종료시 인정)이 완료되면 유효합니다.",
    text2: "핸디캡 배팅시 9이닝 정규이닝 종료시 정상처리, 홈팀 승리시 9회초 종료를 정규이닝으로 함.(그전 종료시 적특)",
    text3:
      "언더오버 배팅시 9이닝 정규이닝 종료시 정상처리, 홈팀 승리시 9회초 종료를 정규이닝으로 함.(그전 종료시 적특)",
  },
];
    ...
    <div>
      ...
      <div className=" mt-25px w-full flex h-16px items-center justify-center text-16px tracking-tight text-white">
        <Route path="/cscenter/policy/sportsgame/live-sport">
          <p className="text-white">라이브스포츠 배팅 규정 (모든 종목의 기본규정과 다를시 별도 표기 하고있습니다.)</p>
        </Route>
