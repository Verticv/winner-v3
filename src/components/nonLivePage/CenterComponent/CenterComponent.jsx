  ...
  return (
    <>
      <div
        ...
        className="items-center mt-61px pt-7px rounded-lg"
      >
        <div
          style={{
        ...
        >
          ...
          <p
            ...
            className="ml-6px text-13px mt-8px mb-6px font-spoqaBold"
          >
            다폴더 보너스 추가 배당
          </p>
          <p
            style={{ color: "#ffd98b", letterSpacing: "-0.031em" }}
            className="ml-6px text-12px font-spoqa"
          >
            (3, 6, 9) 폴더 이상 조합시 지급
          </p>
        </div>
      ...
      >
        <p
          style={{ color: "#eeeeee", letterSpacing: "-0.031em" }}
          className="ml-8px mt-11px mb-8px text-12px font-malgun"
        >
      ...
      >
        <div className="flex ml-7px">
          ...
          >
            ...
            <p
              style={{ color: "#ffffff" }}
              className="-ml-6px mt-8px mb-8px tracking-tight font-malgun text-12px"
            >
              시간순
            </p>
          </div>
          ...
          >
            ...
            <p
              style={{ color: "#ffffff" }}
              className="ml-3px mt-8px mb-8px tracking-tight font-malgun text-12px"
            >
              인기순
            </p>
          </div>
        ...
        <div
          style={{ background: "#666666", width: "79px", height: "29px" }}
