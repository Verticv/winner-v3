            ...
            >
              ...
              >
                <div className="items-start">
                  ...
                  >
                    두폴이상의 경우 배당률 1.31 이상의 한 폴더가 반드시
                    포함되어야 하며 포함되지 않을 경우
                  </p>
                  <p
                    style={{ letterSpacing: "-0.094em" }}
                  ...
                  >
                    <span style={{ marginRight: "3px" }}>•</span> 스포츠
                    경기에서 보너스 엣지를 악용하여 양방 혹은 시간차 양방
                    베팅하는 경우
                  </p>
                  <p
                    style={{ color: "#e5bcf7", letterSpacing: "-0.094em" }}
                  ...
                  >
                    ...
                    농구/배구 경기에서 언/오버 핸디캡을 악용한 걸치기, 양방
                    베팅을 하는 경우
                  </p>
                  <p
                    style={{ color: "#e5bcf7", letterSpacing: "-0.094em" }}
                    className="ml-19px mt-4px text-13px font-malgun"
                  >
                    <span style={{ marginRight: "3px" }}>•</span> 운영진의 실수
                    및 프로그램 오류로 인해 발생된 비정상적인 경기에
                    베팅하는경우
                  </p>
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        데이터 송수신에 대한 시간차를 노려 라이브 베팅을 하는
                        경우 강력 제재 처리 됩니다.
                      </p>
                    </div>
                  </div>
