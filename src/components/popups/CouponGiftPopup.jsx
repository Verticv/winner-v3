            ...
            <div className="w-full flex justify-center">
              ...
              <div className="w-full h-full bg-white1 pl-33px pr-37px"
               style={{ height: "734px", backgroundColor: "#dfdbfa" }}>
                <div className="flex items-center h-19px pt-36px space-x-8px">
                    <img src={Step1} alt="" />
                    <span className="text-16px tracking-tight text-r666666 pt-3px">선물로 보낼 쿠폰을 확인하세요.</span>
                </div>

                 <div className="mt-17px h-64px w-full rounded-8px flex items-center  text-14px tracking-tight " style={{background:'rgb(94, 57, 154)'}}>
                    <span style={{marginLeft:'76px'}} className="text-eeeeee leading-none">선물할 쿠폰</span>
                    <div style={{width:'311px',borderColor:'#a088d7'}} className="h-42px ml-10px bg-white border  rounded-6px flex items-center">
                ...
                <div className="flex items-center h-19px mt-40px space-x-8px">
                    <img src={Step2} alt="" />
                    <span className=" text-16px tracking-tight text-r666666 pt-3px">쿠폰받을 회원을 선택하세요.</span>
                </div>

                <div className="mt-17px h-64px w-full rounded-8px flex items-center  text-14px tracking-tight " style={{background:'rgb(94, 57, 154)'}}>
                <span style={{marginLeft:'63px'}} className="text-eeeeee leading-none">쿠폰받을 회원</span>
                <div style={{width:'311px',borderColor:'#682aa7'}} className="h-42px ml-10px bg-white border  rounded-6px flex items-center">
                    <span className="text-r666666 ml-11px leading-none">아이디를 입력해 주세요.</span>
                </div>
                </div>
