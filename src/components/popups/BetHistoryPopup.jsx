...
import Icon3 from "../../images/myPage/betHistory/icon_4.png";
import Icon4 from "../../images/myPage/betHistory/icon_3.png";
...
import Icon10 from "../../images/myPage/betHistory/icon_11.png";
  ...
  const tabsArray = [
    {
      ...
      id: 0,
      path: "/mypage/bet-history/live-casino",
    },
    {
      text: "스포츠",
      icon: Icon4,
      ...
      id: 2,
      path: "/mypage/bet-history/sports",
    },
    {
      text: "슬롯게임",
      icon: Icon3,
      ...
      id: 1,
      path: "/mypage/bet-history/slot-game",
    },
    {
      text: "호텔카지노",
      icon: Icon5,
      ...
      id: 3,
      path: "/mypage/bet-history/lottery-game",
    },
    {
      text: "e-스포츠",
      icon: Icon6,
      ...
      id: 4,
      path: "/mypage/bet-history/e-sports",
    },
    {
      text: "미니게임",
      icon: Icon7,
      ...
      id: 5,
      path: "/mypage/bet-history/minigame",
    },
    {
      text: "키론가상게임",
      icon: Icon8,
      ...
      id: 6,
      path: "/mypage/bet-history/ar-game",
    },
    {
      text: "피싱게임",
      icon: Icon9,
      iconHighlight: IconHighlight10,
      id: 7,
      path: "/mypage/bet-history/fishing-game",
    },
    {
      text: "티비벳",
      icon: Icon10,
      ...
      id: 8,
      path: "/mypage/bet-history/tv-bet",
    },
  ];
  const subTabsArray1 = [
    ...
    >
      <div className="w-full h-full flex flex-col rounded-20px overflow-hidden">
        ...
        >
          ...
          <button
            className="absolute right-0 mr-22px cursor-pointer z-20 mb-2px"
        ...
        <div
          ...
          className="w-full h-full bg-gray-323231 pt-30px pb-40px"
        >
          <div className="pl-32px pr-36px relative">
            ...
            {selectedTab !== 2 && selectedTab !== 4 && selectedTab !== 8 && (
              <div
                className={`mt-10px w-full px-4px py-3px rounded-4px bg-gray-2b2b2a ${
                  selectedTab === 0 || selectedTab === 3 || selectedTab === 5
                    ? "pb-4px"
                    : ""
                }`}
              >
          ...
          <div
            className={`w-full pl-24px -mt-10px ${
          ...
          >
            <div
              ...
              className="scroll-div2 overflow-y-auto mt-30px py-5px px-6px space-y-28px -pt-10px mr-3px"
            >
              {selectedTab === 0 ? (
