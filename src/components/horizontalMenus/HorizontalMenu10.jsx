...
const HorizontalMenu10 = ({ itemsArray }) => {
    ...
    return items.map((item) => (
      ...
      >
        <div
          ...
          className={`flex w-full  absolute top-0 p-px rounded-4px hover:filter hover:brightness-110`}
        >
          <div
            style={{
              background:
            ...
            className={`w-full rounded-4px flex flex-col justify-end items-center pb-3px h-73px relative`}
          >
