...
const Slots = () => {
    ...
    function SlotList({ items }) {
        return items.map(item => (
            <div style={{height:'182px', width:'308px'}} className="relative select-none cursor-pointer" key={item.id}>
                <div style={{width:'308px'}} className="absolute h-81px flex">
                ...
                <img style={{height:"182px", width:'308px'}} className="object-none z-10" src={SlotBackground} alt="background" />
            </div>
        ));
    }
