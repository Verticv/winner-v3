...
const Slots = () => {
    ...
    function SlotList({ items }) {
        return items.map(item => (
            <div style={{height:'182px'}} className="relative w-308px select-none cursor-pointer" key={item.id}>
                ...
                <img style={{height:"182px"}} className="object-none w-308px z-10" src={SlotBackground} alt="background" />
            </div>
        ));
    }
