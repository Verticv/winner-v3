  ...
  function InboxList({ items }) {
    return items.map((item) => (
      ...
      >
        ...
        <div style={{ width: "117px" }} className="flex justify-center">
          {item.number}
        </div>
        <div style={{ width: "147px" }} className="flex justify-center">
          {item.eventCount}
        </div>
        <div style={{ width: "170px" }} className="flex justify-center">
          {item.betTime}
        </div>
        <div style={{ width: "164px" }} className="flex justify-center">
          {item.type}
        </div>
        ...
        <div style={{ width: "126px" }} className="flex justify-center">
          {item.percentage}
        </div>
        <div style={{ width: "112px" }} className="flex justify-end">
          {item.betAmount}
        </div>
        <div
          style={{ width: "121px", color: item.profit.includes("+") ? "#f04281" : "#444444" }}
          className="flex justify-end"
        >
          {item.profit}
        </div>
        <div style={{ width: "107px", color: item.win ? "#f04281" : "#444444" }} className="flex justify-center">
          {item.win === true ? "승" : "패"}
        </div>
      </div>
    ));
  ...
  return (
    <div className="w-full ">
      ...
      >
        ...
        <div style={{ width: "95px" }} className="flex justify-center">
          베팅내역
        </div>
        <div style={{ width: "126px" }} className="flex justify-center">
          배당률
        </div>
        <div style={{ width: "112px" }} className="flex justify-center">
          베팅금액
        </div>
        <div style={{ width: "121px" }} className="flex justify-center">
          적중/손실
        </div>
